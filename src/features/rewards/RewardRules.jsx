...
import { getRewardRules } from '../../services/API_Service';
...
const RewardRules = () => {
    ...
    useEffect(() => {
        getRewardRules()
            .then(res => {
                convertData(res.data);  // ðŸ‘ˆ correct
            })
                        ...
                        <div className="card-header bg-dark text-white p-4">
                            <div className="d-md-flex justify-content-between align-items-center">
                                <div>
                                    ...
                                    <p className="mb-0 text-white-50 mt-1">Final points = (Unit Points Ã— Weight in KG) for bulky items, or Flat rate for portable items.</p>
                                </div>
                                <div className="mt-3 mt-md-0">
                                    <span className="badge bg-warning text-dark px-3 py-2">Formula: Condition Ã— Weight</span>
                                </div>
                            </div>
                        </div>
