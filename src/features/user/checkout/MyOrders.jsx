...
import { getMyOrdersAPI, cancelOrderAPI, getMyReturnsAPI, getMyReplacesAPI } from '../../../services/API_Service';
...
const MyOrders = () => {
    // âœ… Initialize from cache immediately â€” avoids blank spinner on re-navigation
    ...
    const fetchOrders = async () => {
        ...
        try {
            ...
            // âœ… Persist to sessionStorage so next navigation is instant
    ...
    const confirmCancel = async () => {
        ...
        try {
            ...
            if (response.data.message) {
                ...
                setOrders(updated);
                // âœ… Update cache so re-navigation shows the cancelled status immediately
