...
import { getMyCart, checkoutAPI, validateAddressAPI } from '../../../services/user-api/API_Service';
...
const Checkout = () => {
    ...
    const fetchLastAddress = async () => {
        try {
            const { getMyOrderAddressesAPI } = await import('../../../services/user-api/API_Service');
