...
import { getMyReturnsAPI, getMyReplacesAPI, getMyOrdersAPI, submitReturnRequestAPI, cancelReturnRequestAPI } from '../../../services/API_Service';
            ...
            replacesData
                ...
                .forEach(rep => {
                    ...
                    if (ordersAlreadyIncluded.has(matchedOrder.order_number)) {
                        // Order already in list â€” just enrich it with replacement window info
                        ...
                        // Order not yet included â€” add it with replacement-only flag
                                            ...
                                            <div className="mb-4">
                                                ...
                                                {selectedOrder._replacementWindowOnly && (
                                                    <div className="mb-3 p-3 rounded-3 d-flex align-items-center gap-2"
                                                        ...
                                                        <span className="text-dark-50">â€” You can only return the <strong>replaced product</strong> you received. Original window has closed.</span>
                                                    </div>
                                                )}
                                                                        ...
                                                                        {isReplacedItem && selectedOrder._replacementWindowOpen && (
                                                                            <div className="mb-1">
                                                                                <span className="badge rounded-pill px-2 py-1" style={{ fontSize: 10, background: '#e0e7ff', color: '#4338ca', border: '1px solid #a5b4fc', display: 'inline-block' }}>
                                                                                    <i className="fa-solid fa-arrows-rotate me-1" style={{ fontSize: 9 }}></i>Replaced Product â€” Return Only
                                                                                </span>
                                                                            </div>
                                                                        )}
