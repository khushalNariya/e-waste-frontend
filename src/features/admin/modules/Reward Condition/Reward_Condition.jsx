...
import { Fatch_Reward_Condition_Table } from "./Table";
...
export default function Reward_Condition_admin() {
    ...
    const loadTable = async (page = 1, limit = 5, searchTerm = "") => {
        try {
            const res = await Reward_Condition_API.fetchAll(page, limit, searchTerm);
    ...
    // EDIT
    const edit_Users = (id) => {
        sessionStorage.setItem("edit_Reward_Condition_id", id);
        navigate("/admin/Edit-Reward-Condition");
    };
    ...
    const deleteUsers = async (id) => {
        ...
        try {
            await Reward_Condition_API.Delete(id);   // ✅ API call
            ...
            setSuccessMsg("Reward Conditions deleted successfully.");
    ...
    return (
        <div className="admin-content p-3">
            ...
            <>
                ...
                <Admin_List_Header
                    title="Reward Conditions List"
                    addButtonText="Add Reward Conditions"
                    addButtonLink="/admin/Add-Reward-Condition"
                ...
                <div className="table-responsive">
                    <form id="load-data" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <Admin_Table
                            columns={["Id", "Name", "Display - Name", "Is Active", "Created Date", "Updated Date", "Action"]}
                        >
                            {Fatch_Reward_Condition_Table(rows, edit_Users, deleteUsers, deletingId)}
                        </Admin_Table>
