...
import { getMyReplacesAPI, getMyReturnsAPI, getMyOrdersAPI, submitReplaceRequestAPI, cancelReplaceRequestAPI } from '../../../services/API_Service';
...
const MyReplaces = () => {
    ...
    const fetchReplacesData = async () => {
        ...
        try {
            ...
            // These items cannot be re-replaced â€” only returned.
    ...
    const handleCreateReplaceSubmit = async (e) => {
        ...
        try {
            ...
            // Refresh â€” await ensures quantities + dropdown update before UI settles
            await fetchReplacesData();
        } catch (error) {
                                ...
                                <div className="card-body p-4">
                                    <div className="row g-4">
                                        ...
                                        <div className="col-lg-4">
                                            ...
                                            {/* Cancellation Info Strip â€” shown when request was cancelled */}
                                                ...
                                                return (
                                                    <div className="mt-4 p-3 rounded-3 d-flex align-items-start gap-2 flex-column"
                                                        ...
                                                        <div className="d-flex align-items-center gap-2 fw-semibold" style={{ color: windowOpen ? '#4338ca' : '#64748b' }}>
                                                            ...
                                                            {windowOpen ? 'Replaced Product â€” Return Window Open' : 'Replaced Product â€” Return Window Closed'}
                                                        </div>
                                            ...
                                            <div className="mb-4">
                                                ...
                                                <div className="d-flex flex-column gap-3 p-3 rounded-4 bg-light border">
                                                    {selectedOrder.items?.map(item => {
                                                        ...
                                                        // â”€â”€ Already Successfully Replaced â”€â”€
                                                                    ...
                                                                    <div className="flex-grow-1">
                                                                        <div className="fw-semibold text-dark small d-flex align-items-center gap-2 flex-wrap">
                                                                            ...
                                                                            <span className="badge rounded-pill px-2 py-1"
                                                                                ...
                                                                                {windowOpen ? 'Already Replaced â€” Return Only' : 'Already Replaced â€” Return Window Closed'}
                                                                            </span>
                                                                        </div>
                                                                        <div className="small mt-1" style={{ fontSize: 11, color: windowOpen ? '#b45309' : '#94a3b8' }}>
                                                                            {windowOpen
                                                                                ? <><i className="fa-solid fa-clock-rotate-left me-1"></i>Return window open Â· closes on <strong>{windowCloseDate?.toLocaleDateString('en-IN', { day: 'numeric', month: 'long', year: 'numeric' })}</strong> at 11:59 PM</>
