...
import { getMyCart, checkoutAPI, validateAddressAPI } from '../User-Interface-API/API_Service';
...
const Checkout = () => {
    ...
    const fetchLastAddress = async () => {
        try {
            const { getMyOrderAddressesAPI } = await import('../User-Interface-API/API_Service');
