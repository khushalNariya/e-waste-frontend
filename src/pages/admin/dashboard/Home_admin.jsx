...
import { Fatch_Home_Table } from "./Table";
...
export default function Home_admin() {
    ...
    const [activeTab, setActiveTab] = useState("Home List"); // Default selection
    ...
    const loadTable = async (page = 1, limit = 5, searchTerm = "") => {
        try {
            const res = await Home_API.fetchAll(page, limit, searchTerm);
    ...
    const deleteUsers = async (id) => {
        ...
        try {
            await Home_API.Delete(id);   // ✅ API call
            ...
            {activeTab === "Home List" ? (
                <>
                    ...
                    <div className="d-flex justify-content-between align-items-center mb-3">
                        <h4 className="fw-bold">Home List</h4>
                    ...
                    <div className="table-responsive">
                        <form id="load-data" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <table className="Home-table table table-bordered table-hover ">
                                ...
                                <tbody>
                                    {Fatch_Home_Table(rows, user_type, edit_Users, deleteUsers, deletingId)}
                                </tbody>
