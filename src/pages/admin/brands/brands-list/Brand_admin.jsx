...
export default function Brand_admin() {
    ...
    const loadTable = async (page = 1, limit = 5, searchTerm = "") => {
        try {
            const res = await Brand_API.fetchAll(page, limit, searchTerm);
    ...
    const deleteUsers = async (id) => {
        ...
        try {
            await Brand_API.Delete(id);   // ✅ API call
            ...
            setSuccessMsg("Brand-Name deleted successfully.");
        ...
        <div className="admin-content p-3">
            ...
            <>
                ...
                <div className="d-flex justify-content-between align-items-center mb-3">
                    <h4 className="fw-bold">Brand Name List</h4>

                    <button
                        className="btn btn-success btn-sm"
                        onClick={() => navigate("/admin/Add-Brand")}
                    >
                        <i className="fa fa-plus me-1"></i> Add Brands
                    </button>
                </div>
                ...
                <div className="table-responsive">
                    <form id="load-data" onSubmit={(e) => e.preventDefault()}>
                        ...
                        <table className="Home-table table table-bordered table-hover ">
                            ...
                            <tbody>
                                {Fatch_Brand_Table(rows, edit_Users, deleteUsers, deletingId)}
                            </tbody>
