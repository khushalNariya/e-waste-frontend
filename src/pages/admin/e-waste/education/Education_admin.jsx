...
export default function Education_admin() {
    ...
    const loadTable = async (page = 1, limit = 5, searchTerm = "") => {
        try {
            const res = await Education_API.fetchAll(page, limit, searchTerm);
    ...
    const edit_Users = (id) => {
        ...
        window.location.href = "/admin/Edit-Education";
    };
    ...
    const deleteUsers = async (id) => {
        ...
        try {
            await Education_API.Delete(id);   // ✅ API call
            ...
            setSuccessMsg("Education Value deleted successfully.");
    ...
    return (
        <div className="admin-content p-3">
            ...
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h4 className="fw-bold">Education List</h4>

                <button
                    className="btn btn-success btn-sm"
                    onClick={() => navigate("/admin/Add-Education")}
                >
