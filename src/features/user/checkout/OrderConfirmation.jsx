...
import { getMyOrdersAPI, getMyReturnsAPI, getMyReplacesAPI } from '../../../services/API_Service';
...
// Shared function to map raw API order â†’ UI order object
...
const OrderConfirmation = () => {
    ...
    useEffect(() => {
        ...
        // âœ… Always fetch fresh data from API â€” updates stale cached data silently
        (async () => {
            try {
    ...
    // Replacement return window â€” find if any completed replacement was delivered within 1 day
    ...
    return (
        <div className="confirmation-page">
            {/* Confetti â€” only for success (not cancelled or returned) */}
            ...
            <div className="container">
                ...
                {/* â”€â”€ Returned & Refunded Banner â”€â”€ */}
                {isReturned && (
                    <div className="cancelled-status-box" style={{ background: 'rgba(28, 200, 138, 0.07)', border: '1px solid rgba(28, 200, 138, 0.25)' }}>
                        ...
                        <div>
                            <div className="d-flex align-items-center gap-2 mb-1">
                                ...
                                <span className="badge text-white small fw-semibold" style={{ background: '#1cc88a' }}>âœ“ Refunded</span>
                            </div>
                            <p className="text-dark-50 mb-0" style={{ fontSize: 14, lineHeight: 1.5 }}>
                ...
                <div className="row g-4">
                    ...
                    <div className="col-lg-5">
                        ...
                        <div className="d-grid gap-3">
                            ...
                            {isDelivered && (
                                <>
                                    {/* Window OPEN â€” show only if there are items not yet actioned */}
                                                ...
                                                <div>
                                                    ...
                                                    <div className="small text-muted mt-0.5" style={{ fontSize: 11, whiteSpace: 'nowrap' }}>
                                                        {windowInfo.daysLeft === 0 ? (
                                                            <span>
                                                                Expires <strong className="text-danger">today at 11:59 PM (Last day today âš ï¸)</strong>
                                                            </span>
                                                        ) : (
                                                            <span>
                                    ...
                                    {/* Expired Window â€” show only if there are still untouched items */}
