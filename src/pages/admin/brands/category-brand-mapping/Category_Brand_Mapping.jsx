...
import { Fatch_Category_Brand_Mapping_Table } from "./Table";
import { calculatePagination, generatePaginationButtons } from "../../shared/Pagination/Pagination";
import { useNavigate } from "react-router-dom";



export default function Category_Brand_Mapping() {
    ...
    const loadTable = async (page = 1, limit = 5, searchTerm = "") => {
        try {
            const res = await Category_Brand_Mapping_API.fetchAll(page, limit, searchTerm);
    ...
    // EDIT
    const edit_Users = (id) => {
        sessionStorage.setItem("edit_mapping_id", id);
        navigate("/admin/Edit-Category-Brand");
    };
    ...
    const deleteUsers = async (id) => {
        ...
        try {
            await Category_Brand_Mapping_API.Delete(id);   // ✅ API call
            ...
            setSuccessMsg("Category Wise Brand Value deleted successfully.");
    ...
    return (
        <div className="admin-content p-3">
            ...
            <div className="d-flex justify-content-between align-items-center mb-3">
                <h4 className="fw-bold">Category Wise Brand Value List</h4>

                <button
                    className="btn btn-success btn-sm"
                    onClick={() => navigate("/admin/Add-Category-Brand-Mapping")}
                >
                    <i className="fa fa-plus me-1"></i> Add Category Wise Brand Value
                </button>
            </div>
            ...
            <div className="table-responsive">
                <form id="load-data" onSubmit={(e) => e.preventDefault()}>
                    ...
                    <table className="education-table table table-bordered table-hover ">
                        ...
                        <tbody>
                            {Fatch_Category_Brand_Mapping_Table(rows, edit_Users, deleteUsers, deletingId)}
                        </tbody>
